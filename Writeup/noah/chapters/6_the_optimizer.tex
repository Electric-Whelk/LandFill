...
For equivalent categories of lands~---~i.e.,~two-colour typed taplands~---~I implemented a stripped down version of the weighting system discussed in \secref{sec:landexclusionandpreferences}. Users are given an option on the Interface to prioritize cycles within these categories over othrs within the same category.
